...
.controller('ProformaSiparisCtrl',['$scope','$window','$timeout','db','$filter',ProformaSiparisCtrl])
...
.controller('DepoNakliyeCtrl',['$scope','$window','$timeout','db','$filter',DepoNakliyeCtrl])
...
.controller('FaturaCtrl',['$scope','$window','$timeout','$location','db','$filter','$rootScope',FaturaCtrl])
