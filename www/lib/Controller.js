...
.controller('IrsaliyeCtrl',['$scope','$window','$timeout','$location','db','$filter',IrsaliyeCtrl])
...
.controller('YapilacakTahsilatlarCtrl',['$scope','$window','$location','db',YapilacakTahsilatlarCtrl])