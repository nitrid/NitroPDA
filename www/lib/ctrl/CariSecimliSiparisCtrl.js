function CariSecimliSiparisCtrl($scope,$window,db)
{   
    ...
    $scope.BtnGetir = function()
    {
        ...
        var TmpQuery = 
        {
            ...
            query:  "SELECT " +
                    ...
                    "FROM SIPARISLER " +
                    "WHERE ((sip_musteri_kod = @KODU) OR (@KODU = '')) AND sip_belge_tarih >= @ILKTARIH AND sip_belge_tarih <= @SONTARIH AND sip_tip = @TIP " +
